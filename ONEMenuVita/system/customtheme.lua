	...
	if list.len >0 then
		...
		while true do
			...
			if list.len > 0 then
				...
				screen.print(35,520,strings.pressremove,1.0,theme.style.TXTCOLOR,theme.style.TXTBKGCOLOR,__ALEFT)
			else
				screen.print(35,520,strings.notthemes,1.0,theme.style.TXTCOLOR,theme.style.TXTBKGCOLOR,__ALEFT)
			end
